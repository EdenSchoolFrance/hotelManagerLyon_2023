...
class ChambreManager
{
    ...
    {
        $stmt = $this->bdd->prepare("INSERT INTO client_chambre(id_client, id_chambre, date_debut_reservation_chambre, date_fin_reservation_chambre, num_reservation_chambre) VALUES (?, ?, ?, ?, ?)");
        $stmt->execute(array(
            $id_client,
            $id_chambre,
            $date_debut,
