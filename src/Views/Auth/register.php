  ...
  <form action="/register/" method="post">
    ...
    <div class="blockInput">
      <div class="labelInput">
        ...
        <input type="text" autocomplete="off" name="code_client" value="<?php echo old("code_client"); ?>" placeholder="code_client">
      </div>
    ...
    <div class="blockInput">
      <div class="labelInput">
        ...
        <input id="inputPassword" class="inputPassword" type="password" autocomplete="off" name="password" value="<?php echo old("password"); ?>" placeholder="password">
