...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 13 avr. 2023 à 17:53
...
(1, 'bière', 'lorem', '626686ba8c531-Quad Ice Road 3.jpg', 4),
(2, 'vin', 'lorem', '', 7);
...
(3, 'chambre 201', 'sdfg gsgq qsgs gSG', '6266862e23224-Quad Ice Road 3.jpg', 'dfs', 10, 0, 'fsd');
...
(1, 'dupont', 'martin', 'adminoza@gmail.com', '$2y$10$IYBAvBX3Rqva0qr4NYPPMuGg2sn5AlxYtiyWqQidhycY6451uoU3C'),
(642, 'roland', 'durant', 'e@email.com', '');
...
(642, 2, '2023-04-12', '2023-04-12', 3, 'reserver');
...
(1, 642, '2023-04-12', '2023-04-12', 1, 'reserver');
...
(642, 654, '2023-04-12', '2023-04-12', 1, 'reserver');
...
('643813fe64b0c', 642, 643813, '2023-04-13', 370);
...
INSERT INTO `piscine` (`id_piscine`, `name_piscine`, `description_piscine`, `image_piscine`, `ouverture_piscine`, `fermeture_piscine`, `nettoyage_piscine`, `prix_piscine`) VALUES
(1, 'piscine 1', 'lorem', '', '00:00:00', '00:00:00', '0000-00-00', 200);
...
INSERT INTO `salle` (`id_salle`, `name_salle`, `description_salle`, `image_salle`, `type_salle`, `options_salle`, `prix_salle`) VALUES
(654, 'salle 101', 'lorem', '', 'grande', 'lorem', 69);
...
--
ALTER TABLE `client`
  MODIFY `id_client` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2147483648;

--
-- AUTO_INCREMENT pour la table `client_chambre`
--
ALTER TABLE `client_chambre`
  MODIFY `num_reservation_chambre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `client_piscine`
--
ALTER TABLE `client_piscine`
  MODIFY `num_reservation_piscine` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `client_salle`
--
ALTER TABLE `client_salle`
  MODIFY `num_reservation_salle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `menu`
--
ALTER TABLE `menu`
  MODIFY `id_menu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=456;
...
--
ALTER TABLE `salle`
  MODIFY `id_salle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=655;
